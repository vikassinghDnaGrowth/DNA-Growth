...
//   return (
//     <div className="border-2 border-gray-500 rounded-3xl w-full md:w-5/12 flex flex-col items-center  relative py-10 mb-10 ">
...
//           </h1>
//         </div>
//         <div className="w-9/12 pt-12 flex justify-center  gap-4 bg-customBlue ">
//           {teamMembers.map((member, index) => (
//             <TeamCard key={index} member={member} />
//           ))}
//         </div>
